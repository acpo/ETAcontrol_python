...
# --end
        ...
        tk.Label(text = "Loaded Data", font='bold', fg='blue').grid(row=12,column=0,columnspan=2)
        tk.Label(text = "Temperature file:").grid(row=13,column=0, sticky='w')
        self.TemperatureLabel = tk.Label(text = "")
        self.TemperatureLabel.grid(row=13,column=1, sticky='w')
        self.LoadTempData_button = tk.Button(text = "Load temperature data")
        self.LoadTempData_button.grid(row=14,column=1)
...
# special button for testing
        ...
        self.SwapTempLabel.grid(row=15, column=1)
        self.SwapTempColumns_button = tk.Button(text = "Swap current and voltage columns")
        self.SwapTempColumns_button.grid(row=16, column=1)
...
# special def for testing processing of old data
