## current work:  put dynamic COM port selector into this to avoid hardcoding;
#
...
## start addition for dynamic Serial selection
    def Connect_PS(self, event):
        ...
        if ConnectState:  #checks for True
            ...
            #remoteMode(ConnectState)  #Not required with MasTech
            self.PStext.insert(tk.END, "disconnected serial \n")
            # add commands to disconnect Serial port
            # ser.close()
        else:
