...
#from serial communication.SerialClass import SerialFunctions   # Import Serial Communication Class
import serial
from Serial_Functions import SerialFunctions
...
class MainSerial:
    def __init__(self):
        ...
        # Label
        self.label1 = tkinter.Label(self.mainwin,text = "Serial slogan:",font = ("Song Style",15))
        ...
        self.button_Cancel = tkinter.Button(self.mainwin, text="Clear Received Data",  # Display Text
                                            ...
                                            width=13, height=1)
        self.button_Cancel.place(x=400, y=197)  # Display Control
        ...
        self.myserial = SerialFunctions(int(self.band),self.check,self.data,self.stop)
